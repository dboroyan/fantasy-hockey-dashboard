  ...
  return (
    <Layout title="Season Explorer - Fantasy Hockey Dashboard">
      <div className="space-y-8">
        {/* Season Selector */}
        <div className="card">
          <h2 className="text-2xl font-semibold text-hockey-primary mb-4">Season Explorer</h2>
          <div className="flex items-center gap-4">
            ...
            >
              {seasons.map(season => (
                <option key={season.year} value={season.year} className="text-slate-900">
                  {season.year} Season
                </option>
              ))}
            </select>
        ...
        {currentSeason && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="card">
                <h3 className="text-lg font-semibold text-hockey-primary">Champion</h3>
                <div className="flex items-center gap-2 mt-2">
                  <Trophy className="h-5 w-5 text-hockey-gold" aria-hidden="true" />
                  <p className="text-xl font-semibold text-hockey-primary">
                    {currentSeason.managers.find(m => m.isChampion)?.manager || 'N/A'}
                  </p>
                </div>
                <p className="text-sm text-slate-600 mt-1">{currentSeason.managers.find(m => m.isChampion)?.team || ''}</p>
              </div>
              <div className="card">
                <h3 className="text-lg font-semibold text-hockey-primary">Runner-up</h3>
              ...
              <div className="card">
                <h3 className="text-lg font-semibold text-hockey-primary">Teams</h3>
                <p className="text-xl font-semibold text-slate-800 mt-2">
              ...
              <div className="card">
                <h3 className="text-lg font-semibold text-hockey-primary">Season Status</h3>
                <p className="text-xl font-semibold text-slate-800 mt-2">
            ...
            {selectedSeason === 2024 && (
              <div className="card">
                <h3 className="text-xl font-semibold text-hockey-primary mb-4">2024 Season Notable Points</h3>
            ...
            {/* Standings Table */}
            <div className="card">
              <h3 className="text-xl font-semibold text-hockey-primary mb-4">Final Standings</h3>
            ...
            {currentSeason.playoffResults && (
              <div className="card">
                <h3 className="text-xl font-semibold text-hockey-primary mb-4">Playoff Results</h3>
                <div className="space-y-3">
                  {currentSeason.playoffResults.quarterfinals && (
                    <div>
                      <h4 className="font-semibold text-slate-800">Quarterfinals</h4>
                  ...
                  {currentSeason.playoffResults.semifinals && (
                    <div>
                      <h4 className="font-semibold text-slate-800">Semifinals</h4>
                      <div className="text-sm text-slate-600 space-y-1">
                  ...
                  {currentSeason.playoffResults.finals && (
                    <div>
                      <h4 className="font-semibold text-slate-800">Finals</h4>
